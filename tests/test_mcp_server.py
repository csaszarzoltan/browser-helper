...
EXPECTED_CAPABILITY = {
    ...
    "observe": ("agent.semantic", "ready"),
    "act": ("agent.semantic", "ready"),
    ...
    "export_cookies": ("diagnostics.cookies", "ready"),
    "import_cookies": ("diagnostics.cookies", "ready"),
    "clone_session": ("diagnostics.cookies", "ready"),
    "wait_for": ("browser.core", "ready"),
    "assert": ("browser.core", "ready"),
    "form_fill": ("browser.core", "ready"),
    "form_extract": ("browser.core", "ready"),
    "download": ("browser.core", "ready"),
    "network_block": ("browser.core", "ready"),
    "network_mock": ("browser.core", "ready"),
    ...
    "fleet_run_batch": ("workflow.local", "ready"),
...
TOOL_MODULES = {
    ...
    "export_cookies": "tools",
    "import_cookies": "tools",
    "clone_session": "tools",
    "wait_for": "tools",
    "assert": "tools",
    "form_fill": "tools",
...
def _load_tool_handlers() -> dict[str, object]:
    ...
    handlers = {
        name: getattr(mcp_server.tools, "assert_" if name == "assert" else name)
