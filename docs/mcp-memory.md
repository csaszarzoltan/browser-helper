...
The server now exposes **68 tools** (37 browser/fleet + 4 memory + 6 agent testing + 17 E2E validation + 4 bulk/locale/discovery). Memory tools are backed by the `memory.persistent` capability (status: READY).
