...
All 68 tools are READY-backed (37 browser/fleet + 4 memory + 6 agent testing + 17 E2E validation + 4 bulk/locale/discovery). No EXPERIMENTAL capability maps to a tool this cycle:
...
- `build_tool_defs()` returns the full registry-derived surface (68 tools as of v1.35.0; the count grows as capabilities are added — §4.3 lists the v1.21.0 baseline).
