...
All 38 tools are READY-backed (28 browser/fleet + 4 memory + 6 agent testing). No EXPERIMENTAL capability maps to a tool this cycle:
...
- `build_tool_defs()` returns the full registry-derived surface (38 tools as of v1.27.3; the count grows as capabilities are added — §4.3 lists the v1.21.0 baseline).
