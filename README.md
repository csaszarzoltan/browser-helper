...
fleet bulk (`fleet_run_batch` workers/retries/shard/reporter),
discovery & locale (`browser_discover_tests`, `browser_visual_diff_locale`, `browser_rate_hybrid_idle`),
record bulk (`browser_export_batch_spec`),
persistent memory (`memory_remember/recall/forget/list`),
diagnostics, plus **6 E2E groups + P0–P2 (21 browser_/discovery_ tools)** (`browser_get_accessibility_tree`, `browser_find_semantic_elements`,
...
`browser_inject_storage_state`, `browser_reset_session`, … — 21 browser_/discovery_ tools).
